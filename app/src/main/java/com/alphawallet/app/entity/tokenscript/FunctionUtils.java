 ...
 *
 * NB: this definition would be much better in the library but library doesn't have web3j headers.
 *
 * TODO: Work out if we can include web3j definitions in the library without breaking function signatures
 *
 */
