...
public class AssetDisplayViewModelFactory implements ViewModelProvider.Factory {
    ...
    public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
        return (T) new AssetDisplayViewModel(fetchTokensInteract, genericWalletInteract, transferTicketRouter, redeemAssetSelectRouter, findDefaultNetworkInteract, myAddressRouter, assetDefinitionService, openseaService, tokensService);
    }
}
